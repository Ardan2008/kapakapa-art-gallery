                                    ...
                                    <div class="space-y-6">
                                        ...
                                        <div class="flex items-center gap-6">
                                            <div class="w-24 h-24 flex-shrink-0">
                                                ...
                                                <div onclick="document.getElementById('profileInput').click()"
                                                    ...
                                                    <img id="profileDisplay"
                                                         src="{{ $artist->profile_url ?? 'https://api.dicebear.com/8.x/notionists/svg?seed=artist' }}"
                                            ...
                                            <div class="flex-1">
                                                ...
                                                <input type="text" name="artist[name]" value="{{ $artist->name }}" placeholder="Full Name"
                                        ...
                                        <div class="grid grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <input type="text" name="artist[birthplace]" value="{{ $artist->birthplace }}" placeholder="City, Country"
                                                       class="w-full bg-neutral-800/30 border border-white/5 text-white rounded-xl px-5 py-3.5 focus:border-[#C9A74E]/50 outline-none transition-all text-sm font-bold"
                                                       required>
                                            </div>
                                            <div>
                                                <label class="block text-[10px] text-gray-500 font-black uppercase tracking-widest mb-3">Career</label>
                                                <input type="text" name="artist[career]" value="{{ $artist->career }}" placeholder="e.g. 2015 - Now"
                                                       class="w-full bg-neutral-800/30 border border-white/5 text-white rounded-xl px-5 py-3.5 focus:border-[#C9A74E]/50 outline-none transition-all text-sm font-bold"
                                                       required>
                                            </div>
                                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-8">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="artwork[${i}][name]" value="${art.title || ''}" placeholder="Masterpiece #${i + 1}"
                                ...
                                <div>
                                    ...
                                    <textarea name="artwork[${i}][desc]" placeholder="Story..."
                                              ...
                                              required>${art.art_desc || ''}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="text" name="artwork[${i}][painterRef]" value="${art.painter_ref || ''}" placeholder="Signature"
                                               class="w-full bg-neutral-800/50 border border-white/5 text-white rounded-xl px-4 py-3 focus:border-[#C9A74E]/50 outline-none transition-all text-xs font-bold"
                                               required>
                                    </div>
                                    <div>
                                ...
                                <div class="grid grid-cols-3 gap-3">
                                    <div>
                                        ...
                                        <input type="number" step="0.01" name="artwork[${i}][width]" value="${art.width || ''}" placeholder="W"
                                               class="w-full bg-neutral-800/50 border border-white/5 text-white rounded-xl px-4 py-3 focus:border-[#C9A74E]/50 outline-none transition-all text-xs font-bold text-center">
                                    </div>
                                    <div>
                                        <label class="block text-[8px] text-gray-600 font-black uppercase tracking-widest mb-2">Height</label>
                                        <input type="number" step="0.01" name="artwork[${i}][height]" value="${art.height || ''}" placeholder="H"
                                               class="w-full bg-neutral-800/50 border border-white/5 text-white rounded-xl px-4 py-3 focus:border-[#C9A74E]/50 outline-none transition-all text-xs font-bold text-center">
                                    </div>
                                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-8 pt-6 border-t border-white/5">
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="artwork[${i}][salePrice]" value="${art.sale_price || ''}" placeholder="Sale Price"
                                ...
                                <div class="grid grid-cols-4 gap-3">
                                    ...
                                    <div class="col-span-1">
                                        ...
                                        <div onclick="document.getElementById('certInput_${i}').click()"
                                            ...
                                            <img id="certImg_${i}"
                                                 src="${art.certificate_url || ''}"
                                                 class="${art.certificate_url && !art.certificate_url.endsWith('.pdf') ? '' : 'hidden'}">
                                            ${art.certificate_url && art.certificate_url.endsWith('.pdf')
